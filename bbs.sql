...
CREATE TABLE `reply` (
  ...
  `user_id` int(11) DEFAULT NULL COMMENT '用户id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8 COMMENT='回复表';

-- ----------------------------
-- Records of reply
-- ----------------------------
INSERT INTO `reply` VALUES ('1', '11112', '2018-10-24 12:32:03', '6', '1');
INSERT INTO `reply` VALUES ('2', 'sdfsdf', '2018-10-24 12:32:03', '5', '1');
INSERT INTO `reply` VALUES ('3', '是的方法', '2018-10-24 12:32:03', '5', '1');
INSERT INTO `reply` VALUES ('4', '放松放松的方式', '2018-10-24 12:32:03', '7', '1');
INSERT INTO `reply` VALUES ('5', '正式开始JAVA之旅，首页留名', '2018-10-24 12:32:03', '8', '1');
INSERT INTO `reply` VALUES ('6', 'good,支持下，为什么当时用google code，这种被墙的站访问确实蛋疼，github也挺不错', '2018-10-24 12:32:03', '10', '1');
INSERT INTO `reply` VALUES ('7', '时间比较早了，当时还没有github 这个说来惭愧，一直没怎么更新过', '2018-10-24 12:32:03', '10', '1');
INSERT INTO `reply` VALUES ('8', '占个沙发。。。。。', '2018-10-24 12:32:03', '11', '1');
INSERT INTO `reply` VALUES ('9', '占个沙发。。。。。', '2018-10-24 12:32:03', '12', '1');
INSERT INTO `reply` VALUES ('10', '占个沙发。。。。。', '2018-10-24 12:32:03', '13', '1');
INSERT INTO `reply` VALUES ('11', '支持下，小白确实不会翻墙', '2018-10-24 12:32:03', '10', '3');
INSERT INTO `reply` VALUES ('12', '支持!希望多推荐一些好插件', '2018-10-24 12:32:03', '8', '3');
INSERT INTO `reply` VALUES ('13', '话说刚才粗略浏览了下，发现工作才两年不到的之前面试也会问到里面一些问题', '2018-10-24 12:32:03', '11', '3');
INSERT INTO `reply` VALUES ('14', ' 诚心请教  我是刚出来小白 能告诉我一些面试 的流程 和简历的指导吗？', '2018-10-24 12:32:03', '12', '3');
INSERT INTO `reply` VALUES ('15', '不错,我喜欢你说的话,问题是需要自己去看,去写,去实践的', '2018-10-24 12:32:03', '13', '3');
INSERT INTO `reply` VALUES ('16', '简单来说 你可以理解为把change方法先理解成有返回值的方法，但是你没有接收返回值，所以值没有发生改变,所以还是good and abc', '2018-10-24 12:32:03', '14', '3');
INSERT INTO `reply` VALUES ('17', '下周还能不能活着还是一回事。。。哎，感觉希望渺茫。。外勤经理说下周要带着需求来帮我开发。。。。。尴尬', '2018-10-24 12:32:03', '17', '3');
INSERT INTO `reply` VALUES ('18', '棒棒的', '2018-10-24 12:32:03', '10', '4');
INSERT INTO `reply` VALUES ('19', '支持支持', '2018-10-24 12:32:03', '8', '4');
INSERT INTO `reply` VALUES ('20', '好高端', '2018-10-24 12:32:03', '11', '4');
INSERT INTO `reply` VALUES ('21', '不知道说啥', '2018-10-24 12:32:03', '12', '4');
INSERT INTO `reply` VALUES ('22', '一二三四一二三四像首歌', '2018-10-24 12:32:03', '11', '4');
INSERT INTO `reply` VALUES ('23', '哇呕!真心不会', '2018-10-24 12:32:03', '16', '4');
INSERT INTO `reply` VALUES ('24', '都没有人回答,看看你的人品', '2018-10-24 12:32:03', '15', '4');
INSERT INTO `reply` VALUES ('25', '哎呦喂!我是打酱油的', '2018-10-24 12:32:03', '14', '4');
INSERT INTO `reply` VALUES ('26', '你这个是可以用websocket来写的，碰巧我最近才写了一个例子，是用户调我服务器接口，服务器将接口数据推送到HTML页面，跟你这个是差不多的', '2018-10-24 12:32:03', '18', '4');
INSERT INTO `reply` VALUES ('27', '哇!好难得样子', '2018-10-24 12:32:03', '19', '4');
INSERT INTO `reply` VALUES ('28', '尽力尝试着去弄吧，首先把心态静下来。自己给自己定一个计划，按照计划来熟悉项目。   至于什么一个月内，尽自己最大的能力吧，想着能搞定。 但是如果事实真的弄不完的话，罪不在你。  追求问心无愧。如果公司 因为这个问责你的话，那你就可以考虑换家公司了', '2018-10-24 12:32:03', '17', '4');
INSERT INTO `reply` VALUES ('29', '考虑一下 css3 transform  里面的scale , 横向扩大1.1 .', '2018-10-24 12:32:03', '20', '4');
INSERT INTO `reply` VALUES ('30', '第一可以调整图片本身的尺寸 第二可以使用height强制将图片拉伸 建议使用第一种  因为第二种会使图片看起来很奇怪不美观', '2018-10-24 12:32:03', '20', '4');
INSERT INTO `reply` VALUES ('31', '自己回复太尴尬了', '2018-10-24 12:32:03', '20', '4');
INSERT INTO `reply` VALUES ('32', '好\r\n', '2018-10-24 12:32:03', '20', '5');
INSERT INTO `reply` VALUES ('33', '发代码看看。。', '2018-10-24 12:32:03', '21', '5');
INSERT INTO `reply` VALUES ('34', '啦啦', '2018-10-24 12:32:03', '26', '6');
INSERT INTO `reply` VALUES ('35', '拿到数据，使用poi、jxl之类的工具将数据写入到excel就好了。', '2018-10-24 12:32:03', '25', '6');
INSERT INTO `reply` VALUES ('36', 'str作为基本类型，在传递时实际上是复制了一份这个参数传递给过去，所以在change方法改变str的内容不会改变成员变量的内容；\r\n在传递char[]数组时，把char[]数组当做对象来处理，是传递ch的地址（实际上这里存在地址的复制），所以在内存中成员变量ch和change()方法中的局部变量ch所指向的内存是同一块，这时操作change方法中的ch就是操作成员变量ch。', '2018-10-24 12:32:03', '24', '6');
INSERT INTO `reply` VALUES ('37', '我用chrome不会出现这样的情况呀~\r\n可能是浏览器差异哦,比如vertical-align:top你设置下试试?', '2018-10-24 12:32:03', '23', '6');
INSERT INTO `reply` VALUES ('38', '在body里写一个margin:0px;就好了', '2018-10-24 12:32:03', '10', '6');
INSERT INTO `reply` VALUES ('39', '我的天', '2018-10-24 12:32:03', '8', '6');
INSERT INTO `reply` VALUES ('40', '好样的', '2018-10-24 12:32:03', '11', '6');
INSERT INTO `reply` VALUES ('41', '发代码看看。。', '2018-10-24 12:32:03', '26', '7');
INSERT INTO `reply` VALUES ('42', '在Java里面参数传递都是按值传递”这句话的意思是：按值传递是传递的值的拷贝，按引用传递其实传递的是引用的地址值，所以统称按值传递，在Java里面只有基本类型和按照下面这种定义方式的String是按值传递，其它的都是按引用传递', '2018-10-24 12:32:03', '24', '7');
INSERT INTO `reply` VALUES ('43', '简单来说 你可以理解为把change方法先理解成有返回值的方法，但是你没有接收返回值，所以值没有发生改变,所以还是good and abc', '2018-10-24 12:32:03', '10', '7');
INSERT INTO `reply` VALUES ('44', 'String类型是个final类，所有一旦被复制就改变不了了，今天刚看final时学到的', '2018-10-24 12:32:03', '27', '7');
...
INSERT INTO `users` VALUES ('12', 'lan', 'HAMVRZRssPCADKqGjGWJtQ==', 's', '19');
